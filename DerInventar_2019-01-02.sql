...
# Generation Time: 2019-01-02 13:04:26 +0000
# ************************************************************
...
INSERT INTO `leihobjekte` (`id`, `name`, `beschreibung`, `aid`)
VALUES
	(1,'Dampflockomotive','Tut tut',NULL),
	(2,'Stein','Gesteinsbrocken',NULL),
	(3,'Tomate','Ein richtig tolles Gemüse',NULL),
	(4,'Krasses Teil','Wirklich das beste aller Zeit',NULL),
	(5,'Bürste','Kämmt zuverlässig deinen klasse Hund',NULL);
